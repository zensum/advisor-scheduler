(function (_, Kotlin) {
  ...
  function JsAdvisor(id, name, applications, slots) {
    if (name === void 0)
      name = '';
  ...
  JsAdvisor.prototype.copy_ftp06o$ = function (id, name, applications, slots) {
    return new JsAdvisor(id === void 0 ? this.id : id, name === void 0 ? this.name : name, applications === void 0 ? this.applications : applications, slots === void 0 ? this.slots : slots);
  };
  JsAdvisor.prototype.toString = function () {
    return 'JsAdvisor(id=' + Kotlin.toString(this.id) + (', name=' + Kotlin.toString(this.name)) + (', applications=' + Kotlin.toString(this.applications)) + (', slots=' + Kotlin.toString(this.slots)) + ')';
  };
  ...
  Advisor.prototype.toJsAdvisor = function () {
    ...
    var tmp$_2 = Kotlin.kotlin.collections.copyToArray(destination);
    ...
    return new JsAdvisor(tmp$, tmp$_0, tmp$_2, Kotlin.kotlin.collections.copyToArray(destination_0));
  };
  Advisor.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: 'Advisor',
  ...
  function Advisor_init(advisor, $this) {
    ...
    var tmp$ = advisor.id;
    var tmp$_0 = advisor.name;
    var tmp$_1;
    if (advisor.applications == null) {
      tmp$_1 = Kotlin.kotlin.collections.ArrayList_init_ww73n8$();
    }
     else {
      ...
      tmp$_1 = toMutableList(destination);
    }
    var tmp$_3;
    ...
    Advisor.call($this, tmp$, tmp$_0, tmp$_1, tmp$_3);
    return $this;
  }
