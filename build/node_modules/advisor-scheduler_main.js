(function (_, Kotlin) {
  ...
  function jsAssignApplications(applications, advisors) {
    var destination = Kotlin.kotlin.collections.ArrayList_init_ww73n8$(Kotlin.kotlin.collections.collectionSizeOrDefault_ba2ldo$(applications, 10));
    var tmp$;
    tmp$ = applications.iterator();
    while (tmp$.hasNext()) {
      var item = tmp$.next();
      destination.add_11rb$(new Application(item.id, item.advisor_id, Slot$Factory_getInstance().get_61zpoe$(item.return_at), item.desiredLoan));
    }
    var kotlinApplications = destination;
    var destination_0 = Kotlin.kotlin.collections.ArrayList_init_ww73n8$(Kotlin.kotlin.collections.collectionSizeOrDefault_ba2ldo$(advisors, 10));
    var tmp$_0;
    tmp$_0 = advisors.iterator();
    while (tmp$_0.hasNext()) {
      var item_0 = tmp$_0.next();
      var tmp$_1 = destination_0.add_11rb$;
      var tmp$_2 = item_0.id;
      var tmp$_3 = item_0.name;
      var destination_1 = Kotlin.kotlin.collections.ArrayList_init_ww73n8$();
      var tmp$_4;
      tmp$_4 = kotlinApplications.iterator();
      while (tmp$_4.hasNext()) {
        var element = tmp$_4.next();
        if (Kotlin.equals(item_0.id, element.advisor_id))
          destination_1.add_11rb$(element);
      }
      var tmp$_5 = toMutableList(destination_1);
      var $receiver = item_0.slots;
      ...
      while (tmp$_6.hasNext()) {
        ...
        destination_2.add_11rb$(Slot$Factory_getInstance().get_61zpoe$(item_1));
      }
      tmp$_1.call(destination_0, new Advisor(tmp$_2, tmp$_3, tmp$_5, destination_2));
    }
    var kotlinAdvisors = destination_0;
    var destination_3 = Kotlin.kotlin.collections.ArrayList_init_ww73n8$();
    var tmp$_7;
    tmp$_7 = kotlinApplications.iterator();
    while (tmp$_7.hasNext()) {
      var element_0 = tmp$_7.next();
      var $receiver_0 = element_0.advisor_id;
      var tmp$_8 = $receiver_0 == null || $receiver_0.length === 0;
      if (!tmp$_8) {
        var any$result;
        any$break: do {
          var tmp$_9;
          tmp$_9 = kotlinAdvisors.iterator();
          while (tmp$_9.hasNext()) {
            var element_1 = tmp$_9.next();
            if (Kotlin.equals(element_1.id, element_0.advisor_id)) {
              any$result = true;
              break any$break;
            }
          }
    ...
    return assignApplications(destination_3, kotlinAdvisors);
  }
  function JsAdvisor(id, name, slots) {
    if (name === void 0)
      name = '';
    if (slots === void 0)
      slots = emptyList();
  ...
  JsAdvisor.prototype.copy_bg8n2v$ = function (id, name, slots) {
    return new JsAdvisor(id === void 0 ? this.id : id, name === void 0 ? this.name : name, slots === void 0 ? this.slots : slots);
  };
  JsAdvisor.prototype.toString = function () {
    return 'JsAdvisor(id=' + Kotlin.toString(this.id) + (', name=' + Kotlin.toString(this.name)) + (', slots=' + Kotlin.toString(this.slots)) + ')';
  };
  ...
  JsAdvisor.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.id, other.id) && Kotlin.equals(this.name, other.name) && Kotlin.equals(this.slots, other.slots)))));
  };
  ...
  function Advisor(id, name, applications, slots) {
    if (name === void 0)
      name = '';
  ...
  Advisor.prototype.component4 = function () {
    return this.slots;
  };
  Advisor.prototype.copy_bfcaz1$ = function (id, name, applications, slots) {
    return new Advisor(id === void 0 ? this.id : id, name === void 0 ? this.name : name, applications === void 0 ? this.applications : applications, slots === void 0 ? this.slots : slots);
  };
  Advisor.prototype.toString = function () {
    return 'Advisor(id=' + Kotlin.toString(this.id) + (', name=' + Kotlin.toString(this.name)) + (', applications=' + Kotlin.toString(this.applications)) + (', slots=' + Kotlin.toString(this.slots)) + ')';
  };
  ...
  Advisor.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.id, other.id) && Kotlin.equals(this.name, other.name) && Kotlin.equals(this.applications, other.applications) && Kotlin.equals(this.slots, other.slots)))));
  };
  ...
  Application.prototype.component4 = function () {
    return this.desiredLoan;
  };
  Application.prototype.copy_gw7kjh$ = function (id, advisor_id, slot, desiredLoan) {
    return new Application(id === void 0 ? this.id : id, advisor_id === void 0 ? this.advisor_id : advisor_id, slot === void 0 ? this.slot : slot, desiredLoan === void 0 ? this.desiredLoan : desiredLoan);
  };
  Application.prototype.toString = function () {
    return 'Application(id=' + Kotlin.toString(this.id) + (', advisor_id=' + Kotlin.toString(this.advisor_id)) + (', slot=' + Kotlin.toString(this.slot)) + (', desiredLoan=' + Kotlin.toString(this.desiredLoan)) + ')';
  };
  ...
  Application.prototype.equals = function (other) {
    return this === other || (other !== null && (typeof other === 'object' && (Object.getPrototypeOf(this) === Object.getPrototypeOf(other) && (Kotlin.equals(this.id, other.id) && Kotlin.equals(this.advisor_id, other.advisor_id) && Kotlin.equals(this.slot, other.slot) && Kotlin.equals(this.desiredLoan, other.desiredLoan)))));
  };
  function Slot(time) {
